...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = mx
        ? ["a1-why-recs-matter.html", "a2-types-plain-english.html",
           "a3-ecommerce-vs-fintech.html", "a4-team-pipeline-rr.html",
           "a5-measuring-recs.html", "a6-strategy-ethics-roadmap.html"]
        : ["b1-recsys-foundations.html", "b2-basket-analysis.html", "b3-item-to-item-cf.html",
           "b4-user-to-user-cf.html", "b5-content-based.html",
           "b6-matrix-factorization.html", "b7-modern-deep-recsys.html",
           "b8-evaluation.html", "b9-productionizing.html", "b10-monitoring-iteration.html"];
